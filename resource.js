...
function ResourceCalDAVList()
{
	...
	this.getHeaderValue=function(inputResource)
	{
		...
		var tmp_principal_fullname=decodeURIComponent(inputResource.principalFullname); // full principal username [%F]
		...
		result=result.replace(vCalendar.pre['FRex'], tmp_principal_fullname);
...
// 		inputResource.hrefLabel=inputResource.principalFullname;
// //  		inputResource.hrefLabel=inputResource.principalFullname;
// 		if(!inputResource.principalFullname){
// 			debugger;
// 		} else {
// 			inputResource.hrefLabel=inputResource.principalFullname;
// 			result=inputResource.principalFullname;
// 		}
// 		console.log(inputResource.href+': '+inputResource.principalFullname);
// 		console.log('header: '+result);
// 		return inputResource.principalFullname;
